...
* **lint:** remove unused imports in useSipAccountManager test ([2e7a48c](https://github.com/ironyh/VueSIP/commit/2e7a48c464ee98d9a7458ff8229520a2fd80e26d))
...
* **memory:** properly clean up event listeners in useSipConnection ([65a8b63](https://github.com/ironyh/VueSIP/commit/65a8b63d4b02de3841d327c17728c40b95ac22ef))
* **performance:** bump MAX_BUNDLE_SIZE to 770KB ([46244c5](https://github.com/ironyh/VueSIP/commit/46244c5efd90508d4fb711553ac8e739bcbf352b))
...
* remove @typescript-eslint/no-explicit-any warnings in diagnostics.test.ts ([3d805e9](https://github.com/ironyh/VueSIP/commit/3d805e9c0a69d20900d02262246c2147532b7537))
...
* **test:** add eslint-disable comments for intentional type-edge-case tests ([886b1a4](https://github.com/ironyh/VueSIP/commit/886b1a434fd849252598e037fe1a835070e2f2f2))
...
* **test:** remove as any type assertions in formatters tests ([a0a8cf8](https://github.com/ironyh/VueSIP/commit/a0a8cf8d088ba5bf7ff47d97c8167575a0468da2))
...
* **test:** replace any type with explicit MockAccountState interface ([12b6772](https://github.com/ironyh/VueSIP/commit/12b6772ab4f8eb0397703f6fb49d87de9c6c2efe))
...
* **useAudioDeviceSwitch:** guard currentMicrophone/currentSpeaker with nullish coalescing ([795ec34](https://github.com/ironyh/VueSIP/commit/795ec347bc8a1351421dbc505bebe52bdd294405))
...
* **useSipAccountManager:** improve setActiveAccount error handling and add JSDoc ([affe7f4](https://github.com/ironyh/VueSIP/commit/affe7f43adf11e5e0baa803db0318c951fe8099f))
* **useSipAccountManager:** remove unnecessary computed wrapper and enabledAccounts ([4f87548](https://github.com/ironyh/VueSIP/commit/4f875480be15d818b12a00538b9e075fd814ac7d))
* **useSipAccountManager:** remove unnecessary computed wrapper and fix ref access ([b1c5418](https://github.com/ironyh/VueSIP/commit/b1c54188db5b38cc060e4717a71d94369dfcf494))
