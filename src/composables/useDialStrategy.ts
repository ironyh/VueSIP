...
/** SIP client from `ref()` or `computed(() => getClient())` (read-only .value is enough). */
 ...
 * ```
 */
export function useDialStrategy(sipClient: SipClientInstanceRef): UseDialStrategyReturn {
