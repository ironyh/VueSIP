 ...
 * All metric types
 */
export type AmiMetricTypes = PercentageMetric | DurationMetric | RateMetric | BaseStats

/**
 * All timestamp types
 */
export type AmiTimestampTypes = TimestampFields | CallTimestamps | SessionTimestamps
