...
export const callWaitingExample: ExampleDefinition = {
  ...
  layout: 'inline',
  setupGuide:
    '<p>Handle multiple simultaneous calls with call waiting. Switch between active calls, hold/resume calls, and manage incoming calls while on another call.</p>',
  codeSnippets: [
    {
