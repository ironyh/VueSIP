...
export const videoCallExample: ExampleDefinition = {
  ...
  layout: 'inline',
  setupGuide:
    '<p>Enable video calling with camera support. Use the camera preview to test your camera before starting a call. View all available cameras in multi-camera mode. Grant camera and microphone permissions to use video features.</p>',
  codeSnippets: [
    {
