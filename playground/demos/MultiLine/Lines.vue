  ...
  <div class="mll">
    ...
    <div class="mll__grid" role="list">
      <article
        ...
        class="mll__line"
        :class="[
          `mll__line--${line.state}`,
          { 'mll__line--selected': selected === line.id, 'mll__line--dnd': line.dnd || globalDnd },
        ]"
        role="listitem"
      ...
      >
        ...
        <footer class="mll__line-foot">
          ...
          <button v-else type="button" class="mll__btn mll__btn--dial" @click.stop="dial(line.id)">
            Dial
          </button>
        </footer>
      </article>
    ...
    <p class="mll__hint">
      ...
      <code>appearance-uri</code> via <code>dialog</code> event subscriptions (RFC 4235). Here
      they're local — see the SCA variant for the wire format.
    </p>
  </div>
</template>
...
const lines = ref<Line[]>([
  {
    ...
    state: 'connected',
    name: 'Olivia Chen',
    uri: 'sip:+14155550123@sip.example',
    duration: 242,
    codec: 'opus',
    dnd: false,
  },
  ...
  },
  {
    ...
    state: 'ringing',
    name: 'Unknown',
    uri: 'sip:+442079461001@sip.example.co.uk',
    dnd: false,
  },
...
.mll__line--ringing {
  border-color: var(--accent);
  animation: mll-ring 1.1s ease-in-out infinite;
}
.mll__line--connected {
