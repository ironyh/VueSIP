<template>
  <div class="bl">
    ...
    <div class="bl__search">
      ...
      />
      <span class="bl__search-count"> {{ filtered.length }} / {{ entries.length }} </span>
    </div>
...
const entries = ref<Entry[]>([
  {
    id: 1,
    number: '+18005551212',
    reason: 'Robocaller — warranty scam',
    active: true,
    addedAt: Date.now() - 4 * DAY,
    hits: 17,
  },
  {
    id: 2,
    number: '+442079460000',
    reason: 'Phishing — tax refund',
    active: true,
    addedAt: Date.now() - 11 * DAY,
    hits: 4,
  },
  {
    id: 3,
    number: 'sip:anonymous@unknown.invalid',
    reason: 'Anonymous',
    active: true,
    addedAt: Date.now() - 2 * HOUR,
    hits: 1,
  },
  { id: 4, number: '+14155550199', active: false, addedAt: Date.now() - 30 * DAY, hits: 23 },
  {
    id: 5,
    number: 'sip:spam@evil.example',
    reason: 'Known spam',
    active: true,
    addedAt: Date.now() - 60 * DAY,
    hits: 312,
  },
])
