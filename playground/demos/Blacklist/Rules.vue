  ...
  <div class="blr">
        ...
        >
          ...
          <label class="blr__switch">
            ...
            <span class="blr__switch-track" aria-hidden="true">
              <span class="blr__switch-thumb"></span>
            </span>
    ...
    <footer class="blr__footer">
      <span class="blr__status">
        <span class="blr__status-dot" :class="{ 'blr__status-dot--on': enabledCount > 0 }"></span>
...
const actions: Action[] = [
  { id: 'reject', label: 'Reject', desc: 'Decline with a 603 response', code: 'SIP 603 Decline' },
  {
    id: 'voicemail',
    label: 'To voicemail',
    desc: 'Route straight to voicemail',
    code: 'Forward · VM',
  },
  { id: 'busy', label: 'Return busy', desc: 'Reply with 486 Busy Here', code: 'SIP 486 Busy' },
  {
    id: 'silent',
    label: 'Silent drop',
    desc: 'Accept and hang up immediately',
    code: 'SIP 200 → BYE',
  },
]
