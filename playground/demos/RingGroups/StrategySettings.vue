<template>
  <div class="rgs">
    ...
    <section class="rgs__section">
      ...
      <div class="rgs__row">
        <label class="rgs__field">
          ...
          <input
            type="number"
            v-model.number="state.ringTimeout"
            min="5"
            max="120"
            class="rgs__input"
          />
        ...
        <label class="rgs__field">
          ...
          <input
            type="number"
            v-model.number="state.retryDelay"
            min="0"
            max="30"
            class="rgs__input"
          />
      ...
      <p class="rgs__hint">
        Asterisk Queue: <code>timeout={{ state.ringTimeout }}</code
        >, <code>retry={{ state.retryDelay }}</code
        >. Keep short — users abandon after ~20 s.
      </p>
    </section>
    ...
    <footer class="rgs__foot">
      <span
        >Set per-queue in Asterisk <code>queues.conf</code>. Changes pick up on
        <code>queue reload</code>; no need to touch the dialplan.</span
      >
    </footer>
  </div>
</template>
