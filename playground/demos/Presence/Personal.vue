    ...
    <header class="pers__card">
      ...
      <div class="pers__card-body">
        ...
        <span class="pers__state" :class="`pers__state--${current.id}`">
          <span class="pers__state-dot" aria-hidden="true" />
    ...
    <section class="pers__section">
      ...
      <ul class="pers__states" role="radiogroup" aria-label="Presence state">
        <li v-for="s in states" :key="s.id">
          ...
          >
            <span class="pers__state-btn-dot" :class="`pers__state-btn-dot--${s.id}`" aria-hidden="true" />
    ...
    <section class="pers__section">
      <label class="pers__field">
        ...
        <input
          ...
          maxlength="60"
        />
        <span class="pers__hint">
          {{ note.length }} / 60 · Published via PIDF
        </span>
      </label>
    </section>
...
interface PresenceState { id: StateId; label: string; desc: string }
...
const tick = window.setInterval(() => { nowTick.value = Date.now() }, 10_000)
...
.pers__avatar--busy::after { background: var(--c-busy); }
.pers__avatar--away::after { background: var(--c-away); }
.pers__avatar--dnd::after { background: var(--c-dnd); }
.pers__avatar--offline::after { background: var(--c-offline); }

.pers__card-body { display: flex; flex-direction: column; gap: 0.1rem; flex: 1; min-width: 0; }
.pers__name { font-size: 1.02rem; font-weight: 600; }
.pers__uri {
  font-family: var(--mono);
  font-size: 0.72rem;
  color: var(--muted);
...
.pers__state-dot {
  width: 8px; height: 8px; border-radius: 50%; background: var(--c-available);
}
.pers__state--busy { color: var(--c-busy); }
.pers__state--busy .pers__state-dot { background: var(--c-busy); }
.pers__state--away { color: var(--c-away); }
.pers__state--away .pers__state-dot { background: var(--c-away); }
.pers__state--dnd { color: var(--c-dnd); }
.pers__state--dnd .pers__state-dot { background: var(--c-dnd); }
.pers__state--offline { color: var(--c-offline); }
.pers__state--offline .pers__state-dot { background: var(--c-offline); }
.pers__state--available { color: var(--c-available); }
.pers__state-note {
  text-transform: none;
  letter-spacing: 0;
  font-size: 0.72rem;
...
.pers__since { display: flex; flex-direction: column; align-items: flex-end; gap: 0.1rem; min-width: 5rem; }
.pers__since-eyebrow {
  font-family: var(--mono);
  font-size: 0.58rem;
  font-weight: 700;
...
.pers__section { display: flex; flex-direction: column; gap: 0.45rem; }
.pers__eyebrow {
  font-family: var(--mono);
  font-size: 0.62rem;
  font-weight: 700;
...
.pers__state-btn:hover { border-color: color-mix(in srgb, var(--accent) 45%, var(--rule)); }
.pers__state-btn--on {
...
.pers__state-btn-dot--available { background: var(--c-available); }
.pers__state-btn-dot--busy { background: var(--c-busy); }
.pers__state-btn-dot--away { background: var(--c-away); }
.pers__state-btn-dot--dnd { background: var(--c-dnd); }
.pers__state-btn-dot--offline { background: var(--c-offline); }
...
.pers__field { display: flex; flex-direction: column; gap: 0.3rem; }
.pers__input {
  background: var(--paper);
  border: 1px solid var(--rule);
  border-radius: 2px;
...
.pers__input:focus { outline: none; border-color: var(--accent); }
.pers__hint {
  font-family: var(--mono);
  font-size: 0.62rem;
  color: var(--muted);
...
.pers__trigger-label input { accent-color: var(--accent); }
.pers__trigger-label em { font-style: normal; font-weight: 600; color: var(--accent); }
.pers__trigger-hint {
  font-family: var(--mono);
  font-size: 0.68rem;
  color: var(--muted);
