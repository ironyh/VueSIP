  ...
  <div class="cnt">
    <header class="cnt__head">
      <div>
        ...
        <h3 class="cnt__title">{{ favoriteCount }} favorites · {{ onlineCount }} online</h3>
      </div>
    ...
    <div class="cnt__search">
      ...
      />
      <span class="cnt__count"
        >{{ visible.length }} match{{ visible.length === 1 ? '' : 'es' }}</span
      >
    </div>
    ...
    <ul v-if="visible.length" class="cnt__grid" role="list">
      <li v-for="c in visible" :key="c.id" class="cnt__card">
        <div class="cnt__avatar" :style="{ background: avatarColor(c.name) }">
          ...
          <span
            class="cnt__presence"
            :class="`cnt__presence--${c.presence}`"
            :title="c.presence"
            aria-hidden="true"
          ></span>
        </div>
        <div class="cnt__body">
          ...
          <div class="cnt__actions">
            <button
              type="button"
              class="cnt__action cnt__action--call"
    ...
    <footer class="cnt__foot">
      <span class="cnt__source"
        >Sources · <code>ldap</code> · <code>carddav</code> · <code>crm</code></span
      >
