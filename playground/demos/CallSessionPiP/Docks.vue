<template>
  <div class="csd">
    ...
    <div class="csd__stage" aria-label="Dock preview">
      <div class="csd__app">
        <div class="csd__app-head">
          <span class="csd__app-dot"></span><span class="csd__app-dot"></span
          ><span class="csd__app-dot"></span>
    ...
    <footer class="csd__foot">
      <span>
        The floating widget is one Vue component mounted at app root with
        <code>position: fixed</code>. Users drag it, we persist the coordinates; route changes do
        not unmount it, so the call survives navigation.
      </span>
    </footer>
  </div>
</template>
...
.csd__pos-frame--tl span {
  top: 4px;
  left: 4px;
}
.csd__pos-frame--tr span {
  top: 4px;
  right: 4px;
}
.csd__pos-frame--bl span {
  bottom: 4px;
  left: 4px;
}
.csd__pos-frame--br span {
  bottom: 4px;
  right: 4px;
}
.csd__pos-frame--bar span {
  bottom: 4px;
  left: 4px;
  right: 4px;
  width: auto;
