<template>
  <div class="vgallery">
    ...
    >
      ...
      >
        <div
          class="vgallery__tile-inner"
          :aria-label="`${p.name} ${p.videoOff ? 'video off' : 'video'}`"
        >
          ...
          <span class="vgallery__name"> {{ p.name }}{{ p.isSelf ? ' (you)' : '' }} </span>

          <span class="vgallery__flags" aria-hidden="true">
            <span v-if="p.muted" class="vgallery__flag vgallery__flag--muted" title="Muted"
              >🎙</span
            >
            <span v-if="p.videoOff" class="vgallery__flag" title="Video off">📹</span>
            <span v-if="p.hand" class="vgallery__flag vgallery__flag--hand" title="Hand raised"
              >✋</span
            >
            <span v-if="p.speaking" class="vgallery__flag vgallery__flag--speaking" title="Speaking"
              >◉</span
            >
          </span>
        </div>
    ...
    <div class="vgallery__bar">
      ...
      <button type="button" class="vgallery__ctrl" @click="addParticipant">+ Invite</button>
      <span class="vgallery__spacer"></span>
...
.vgallery__flag--muted {
  color: var(--accent);
}
.vgallery__flag--hand {
  color: #eab308;
}
.vgallery__flag--speaking {
  color: #48bb78;
}
