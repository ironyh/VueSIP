  ...
  <div class="qmon">
    <header class="qmon__head">
      <div>
        ...
        <h3 class="qmon__title">{{ queues.length }} queues · {{ totalWaiting }} waiting</h3>
      </div>
      <label class="qmon__refresh">
        <input type="checkbox" v-model="autoRefresh" />
        <span>Live</span>
        <span class="qmon__dot" :class="{ 'qmon__dot--on': autoRefresh }"></span>
      </label>
    </header>
...
.qmon__dot--on {
  ...
  animation: qmon-pulse 1.4s ease-in-out infinite;
}
