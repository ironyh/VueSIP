...
import { calculateMos, getNetworkBanner, getQualityVerdict, type QualitySnapshot } from './qualityModel'
...
const current = computed(() => scenarios.find((option) => option.id === scenario.value)?.snapshot ?? scenarios[0].snapshot)
