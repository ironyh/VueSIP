<template>
  <div class="crl">
    ...
    <section v-for="cat in categories" :key="cat.id" class="crl__cat">
      ...
      <ul class="crl__list" role="list">
        <li
          ...
          class="crl__row"
          :class="{
            'crl__row--selected': selected === t.id,
            'crl__row--playing': playing === t.id,
          }"
        >
          <button
            type="button"
          ...
          <div class="crl__tools">
            <button
              ...
              @click="selected = t.id"
            >
              {{ selected === t.id ? 'Default' : 'Set default' }}
            </button>
            <button
    ...
    <div class="crl__upload">
      ...
      <button type="button" class="crl__upload-btn" @click="mockUpload">+ Upload file</button>
    </div>
  </div>
</template>
...
const tones = ref<Tone[]>([
  {
    id: 'bell-1955',
    name: 'Bell Model 500 · ring',
    category: 'classic',
    duration: 4.0,
    size: '48 KB',
    waveform: 'sine 20Hz AM',
  },
  {
    id: 'trimline',
    name: 'Trimline · electronic warble',
    category: 'classic',
    duration: 3.2,
    size: '62 KB',
    waveform: 'square 1000/1200Hz',
  },
  {
    id: 'office-pbx',
    name: 'Office PBX double-ring',
    category: 'classic',
    duration: 3.8,
    size: '44 KB',
    waveform: '440+480Hz · 2s on/4s off',
  },
  {
    id: 'marimba',
    name: 'Marimba',
  ...
  },
  {
    ...
    duration: 2.2,
    size: '41 KB',
    waveform: 'G/B/D triad',
  },
  {
    id: 'rfc3261-us',
    name: 'US cadence (RFC 3261)',
    category: 'rfc3261',
    duration: 6.0,
    size: '120 KB',
    waveform: '440+480Hz · 2s/4s',
  },
  {
    id: 'rfc3261-uk',
    name: 'UK cadence',
    ...
    duration: 6.0,
    size: '120 KB',
    waveform: '400+450Hz · 0.4/0.2/0.4/2s',
  },
])
