<template>
  <div class="console">
    <div v-if="!isConnected" class="console__status">
      <span class="console__status-led" aria-hidden="true"></span>
    ...
    >
      <div class="console__live-head">
        <span class="console__pulse" aria-hidden="true"></span>
      ...
      <div class="console__actions">
        <button
          type="button"
          class="console__cta console__cta--go"
          @click="answer({ audio: true, video: false })"
        >
          Answer
        </button>
        <button type="button" class="console__cta console__cta--stop" @click="reject(486)">
          Reject
        </button>
      </div>
