  ...
  <div class="ahist">
    ...
    <section class="ahist__rank">
      ...
      <div class="ahist__rank-bar">
        <span
          class="ahist__rank-fill"
          :style="{ width: 100 - (rank - 1) * (100 / teamSize) + '%' }"
        ></span>
      </div>
...
const gridLines = computed(() => [0.25, 0.5, 0.75].map((f) => ({ y: chartH * f })))
