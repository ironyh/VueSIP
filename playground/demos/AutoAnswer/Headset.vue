  ...
  <div class="aah">
    ...
    <div class="aah__device">
      <div class="aah__icon" aria-hidden="true">
        <svg viewBox="0 0 64 64" width="56" height="56">
          ...
          />
          <rect x="10" y="30" width="10" height="14" rx="2" fill="currentColor" opacity="0.15" stroke="currentColor" stroke-width="2"/>
          <rect x="44" y="30" width="10" height="14" rx="2" fill="currentColor" opacity="0.15" stroke="currentColor" stroke-width="2"/>
          <circle v-if="buttonHeld" cx="49" cy="37" r="3" fill="var(--accent)" />
        </svg>
      </div>
      <div class="aah__device-meta">
        <dl class="aah__specs">
          <div><dt>Transport</dt><dd>USB HID · Call Control Usage Page (0x0B)</dd></div>
          <div><dt>Vendor ID</dt><dd>0x047F · Plantronics</dd></div>
    ...
    <section class="aah__section">
      ...
      <p class="aah__hint">
        ...
        <code>navigator.hid</code> or the OEM SDK (Jabra, Poly). Browsers relay the HID byte; the app maps it to
      ...
      <div class="aah__sim-grid">
        ...
        <button type="button" class="aah__btn" @click="tap('mute')" :class="{ 'aah__btn--active': muted }">
          <span class="aah__btn-glyph">🎤</span>
...
interface LogEntry { id: number; time: string; event: string; bytes: string }
const log = ref<LogEntry[]>([])
let logId = 0

const mappings = [
  { id: 1, button: 'Hook switch', action: 'Accept incoming (auto-answer on long press)', usage: '0x0B · 0x20' },
...
.aah__head { display: flex; justify-content: space-between; align-items: flex-end; gap: 0.75rem; flex-wrap: wrap; }
.aah__eyebrow {
  font-family: var(--mono); font-size: 0.64rem; font-weight: 700;
  letter-spacing: 0.18em; text-transform: uppercase; color: var(--muted);
}
.aah__title { margin: 0.1rem 0 0; font-size: 1rem; font-weight: 600; }

.aah__state {
  display: inline-flex; align-items: center; gap: 0.35rem;
  font-family: var(--mono); font-size: 0.66rem;
  letter-spacing: 0.1em; text-transform: uppercase; color: var(--muted);
  padding: 0.2rem 0.55rem; border: 1px solid var(--rule); border-radius: 2px;
}
.aah__state--on { color: var(--ok); border-color: var(--ok); background: color-mix(in srgb, var(--ok) 8%, transparent); }
.aah__dot { width: 7px; height: 7px; border-radius: 50%; background: currentColor; }

.aah__device {
  display: flex; gap: 0.9rem; align-items: center;
  background: var(--paper); border: 1px solid var(--rule); border-radius: 2px; padding: 0.8rem 0.9rem;
  color: var(--accent);
}
.aah__icon { flex-shrink: 0; }
.aah__device-meta { flex: 1; }
.aah__specs { margin: 0; display: grid; grid-template-columns: 1fr; gap: 0.2rem; }
.aah__specs div { display: grid; grid-template-columns: 6.5rem 1fr; gap: 0.5rem; }
.aah__specs dt {
  font-family: var(--mono); font-size: 0.62rem; letter-spacing: 0.1em;
  text-transform: uppercase; color: var(--muted);
}
.aah__specs dd {
  margin: 0; font-family: var(--mono); font-size: 0.76rem; color: var(--ink);
}

.aah__section { display: flex; flex-direction: column; gap: 0.45rem; }
.aah__section-title {
  font-family: var(--mono); font-size: 0.64rem; font-weight: 700;
  letter-spacing: 0.14em; text-transform: uppercase; color: var(--muted);
}
.aah__hint {
  margin: 0; font-size: 0.82rem; line-height: 1.5; color: var(--muted);
}
.aah__hint code {
...
.aah__map { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.3rem; }
.aah__map-row {
  display: grid;
...
.aah__sep { color: var(--muted); text-align: center; font-family: var(--mono); }
.aah__action { font-size: 0.82rem; color: var(--ink); }
.aah__usage {
  ...
  padding: 0.08rem 0.35rem; letter-spacing: 0.05em;
}
@media (max-width: 620px) {
  .aah__map-row { grid-template-columns: 1fr; }
  .aah__sep, .aah__usage { justify-self: start; }
}
...
.aah__btn {
  ...
  background: var(--paper); border: 1px solid var(--rule); border-radius: 2px;
  padding: 0.7rem 0.6rem; cursor: pointer; transition: all 0.12s;
  color: var(--ink); font-family: var(--sans);
}
.aah__btn:hover { border-color: color-mix(in srgb, var(--accent) 50%, var(--rule)); }
.aah__btn--active {
  border-color: var(--accent);
  background: color-mix(in srgb, var(--accent) 12%, transparent);
  color: var(--accent);
}
.aah__btn-glyph { font-size: 1.4rem; line-height: 1; }
.aah__btn-label {
  font-family: var(--mono); font-size: 0.66rem;
  letter-spacing: 0.1em; text-transform: uppercase;
}
.aah__btn-hint { font-family: var(--mono); font-size: 0.6rem; color: var(--muted); }
...
.aah__log-row:last-child { border-bottom: 0; }
.aah__log-t { color: var(--muted); }
.aah__log-event { color: var(--ink); }
.aah__log-bytes { color: var(--accent); letter-spacing: 0.05em; }
.aah__log-empty {
