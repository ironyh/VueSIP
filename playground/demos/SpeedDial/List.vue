...
const contacts = ref<DirectoryContact[]>([
  { id: 1, name: 'Front desk', number: 'sip:100@pbx.example.com', calls: 42, avgDuration: 72, lastCall: now - 35 * min, vip: false },
  { id: 2, name: 'Alex Rivera', number: 'sip:alex@example.com', calls: 28, avgDuration: 320, lastCall: now - 3 * hour, vip: true },
  { id: 3, name: 'Sales team', number: 'sip:200@pbx.example.com', calls: 19, avgDuration: 210, lastCall: now - 1 * day, vip: false },
  { id: 4, name: 'Support on-call', number: 'sip:911@pbx.example.com', calls: 11, avgDuration: 480, lastCall: now - 2 * day, vip: true },
  { id: 5, name: 'Priya Shah', number: 'sip:priya@example.com', calls: 8, avgDuration: 165, lastCall: now - 6 * day, vip: false },
  { id: 6, name: 'Voicemail', number: 'sip:*97@pbx.example.com', calls: 5, avgDuration: 45, lastCall: now - 12 * day, vip: false },
])
...
.list-demo__sort-btn:hover { color: var(--ink); }
...
.list-demo__row:hover { border-color: color-mix(in srgb, var(--accent) 40%, var(--rule)); }
...
.list-demo__call:hover:not(:disabled) { background: var(--accent); border-color: var(--accent); }
.list-demo__call:disabled { opacity: 0.55; cursor: not-allowed; }
.list-demo__call--on { background: var(--accent); border-color: var(--accent); }
.list-demo__call-icon { font-weight: 400; }
...
.list-demo__star:hover { color: var(--accent); border-color: var(--accent); }
.list-demo__star--on {
...
@media (max-width: 620px) {
  ...
  .list-demo__stats { grid-column: 2 / 4; justify-content: flex-end; }
  .list-demo__actions { grid-column: 1 / 4; justify-content: flex-end; }
}
</style>
