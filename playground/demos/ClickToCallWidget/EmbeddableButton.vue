  ...
  <div class="ctw">
    <header class="ctw__head">
      ...
      <div class="ctw__state" role="status" aria-live="polite">
        <span class="ctw__state-dot" :class="`ctw__state-dot--${state}`" aria-hidden="true"></span>
    ...
    <div class="ctw__host">
      <div class="ctw__browser">
        <div class="ctw__browser-bar">
          <span class="ctw__browser-dot"></span>
          <span class="ctw__browser-dot"></span>
          <span class="ctw__browser-dot"></span>
        ...
        <article class="ctw__page">
          ...
          <p class="ctw__page-copy">
            Our team covers NA, EMEA, and APAC between 06:00 and 22:00 UTC. Pick up the phone — or
          ...
          <div class="widget" :class="`widget--${theme}`">
            ...
            <div v-else class="widget__panel">
              ...
              <div v-if="state === 'ringing'" class="widget__pulse" aria-hidden="true"></div>
      ...
      <aside class="ctw__side">
        ...
        <p class="ctw__side-note">
          The button above is the widget exactly as it renders on the host page. Host CSS never
          leaks in — the widget ships its own styles in a Shadow DOM root.
        </p>
      </aside>
    </div>
  </div>
...
.ctw__state-dot--ringing {
  background: #d4811f;
  animation: ctwPulse 1s infinite;
}
.ctw__state-dot--on-call {
  background: var(--ok);
}
.ctw__state-dot--ended {
  background: #a41d08;
}
.ctw__timer {
...
.widget__hang:hover {
  background: color-mix(in srgb, #000 50%, var(--w-bg));
}
