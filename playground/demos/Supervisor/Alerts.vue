  ...
  <div class="salr">
    <header class="salr__head">
      <div>
        ...
        <h3 class="salr__title">{{ openAlerts.length }} open · {{ criticalCount }} critical</h3>
      </div>
    ...
    <section class="salr__thresholds">
      ...
      <div class="salr__thr-grid">
        <label class="salr__thr">
          ...
          <input
            type="number"
            v-model.number="thresholds.wait"
            class="salr__thr-input"
            min="10"
            max="600"
          />
        ...
        <label class="salr__thr">
          ...
          <input
            type="number"
            v-model.number="thresholds.abandon"
            class="salr__thr-input"
            min="1"
            max="50"
          />
        ...
        <label class="salr__thr">
          ...
          <input
            type="number"
            v-model.number="thresholds.callLength"
            class="salr__thr-input"
            min="60"
            max="1800"
          />
    ...
    <ul class="salr__list" role="list">
      ...
      >
        ...
        <div class="salr__row-body">
          ...
          <p class="salr__detail">
            <span
              >queue · <strong>{{ a.queue }}</strong></span
            >
        ...
        <div class="salr__row-tools">
          <button v-if="!a.acked" type="button" class="salr__ack" @click="ack(a.id)">Ack</button>
      ...
      <li v-if="!alerts.length" class="salr__empty">Quiet. Everything within thresholds.</li>
    </ul>
  </div>
</template>
...
const criticalCount = computed(
  () => openAlerts.value.filter((a) => a.severity === 'critical').length
)
...
.salr__row--critical .salr__severity {
  color: var(--crit);
}
.salr__row--warning .salr__severity {
  color: var(--warn);
}
.salr__row--info .salr__severity {
  color: var(--info);
}
.salr__kind {
  font-family: var(--mono);
