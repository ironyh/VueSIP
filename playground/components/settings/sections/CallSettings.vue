<template>
  <div class="call-settings">
    ...
    <div class="settings-section">
      ...
      <!-- No Answer Timeout -->
      <div v-if="localSettings.forwardOnNoAnswer && !localSettings.forwardAllCalls" class="form-group">
        <label class="form-label">
          No Answer Timeout
    ...
    <div class="settings-section">
      ...
      <div class="form-group checkbox-group">
        ...
        <p class="help-text">
          Use ICE for NAT traversal and better connectivity (Recommended: ON)
        </p>
      </div>
...
function validateForwardUri() {
  ...
  if (!sipPattern.test(localSettings.forwardToUri) && !phonePattern.test(localSettings.forwardToUri)) {
