    ...
    <div class="settings-section">
      ...
      <div class="form-group checkbox-group">
        <label class="checkbox-label">
          <input
            v-model="localSettings.useEncryption"
            type="checkbox"
    ...
    <div class="settings-section">
      ...
      <div class="form-group">
        ...
        <input
          ...
          step="1000"
        />
        <p class="help-text">Time between registration retry attempts (5000-300000ms, default: 30000)</p>
      </div>
    </div>
...
const localSettings = reactive<Partial<SipClientConfig>>({
  ...
  registrationOptions: {
    ...
    registrationRetryInterval: props.modelValue.registrationOptions?.registrationRetryInterval || 30000
  }
})
