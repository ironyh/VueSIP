  ...
  <div class="ami-settings">
    <div class="settings-section">
      ...
      <div class="form-group checkbox-group">
        ...
        <p class="help-text">Enable to access queue monitoring, supervisor features, and advanced call control</p>
      </div>
    </div>
    ...
    <template v-if="localSettings.enabled">
      ...
      <div class="settings-section">
        ...
        <div class="form-group" :class="{ disabled: !localSettings.autoReconnect }">
          <label for="ami-reconnect-delay" class="form-label">
            Reconnect Delay (ms)
          </label>
          <input
        ...
        <div class="form-group" :class="{ disabled: !localSettings.autoReconnect }">
          <label for="ami-max-attempts" class="form-label">
            Max Reconnect Attempts
          </label>
          <input
            id="ami-max-attempts"
        ...
        <!-- Connection Timeout -->
        <div class="form-group">
          <label for="ami-timeout" class="form-label">
      ...
      <div class="info-box">
        <h4>📘 About AMI</h4>
        <p>
          The Asterisk Manager Interface (AMI) provides advanced features:
        </p>
        <ul>
        ...
        <p class="note">
          ...
          <a href="https://github.com/staskobzar/amiws" target="_blank" rel="noopener">github.com/staskobzar/amiws</a>
...
function validateUrl(): void {
  ...
  } else if (!localSettings.value.url.startsWith('ws://') && !localSettings.value.url.startsWith('wss://')) {
