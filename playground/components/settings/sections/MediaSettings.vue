  ...
  <div class="media-settings">
    ...
    <div class="settings-section">
      ...
      <div class="form-group">
        ...
        <p class="help-text">
          Opus provides best quality and bandwidth efficiency. Fallback to other codecs if not supported.
        </p>
      </div>
      ...
      <div class="form-group">
        ...
        <p class="help-text">{{ audioPresets.find(p => p.value === audioQualityPreset)?.description }}</p>
      </div>
    </div>
    ...
    <div class="settings-section">
      ...
      <div class="form-group">
        ...
        <input
          ...
          @change="updateVideoConstraints"
        />
        <p class="help-text">Higher bitrate improves quality but uses more bandwidth (256-4096 kbps)</p>
      </div>
    </div>
    ...
    <div class="settings-section">
      ...
      <div class="form-group checkbox-group">
        ...
        <p class="help-text">Reduces background noise like typing, fans, traffic (Recommended: ON)</p>
      </div>
    ...
    <div class="settings-section">
      ...
      <div class="form-group">
        ...
        <p class="help-text">
          ...
          <a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaTrackConstraints" target="_blank" class="help-link">Documentation</a>
        </p>
      </div>
...
const audioPresets = [
  ...
  { value: 'medium', label: 'Medium', description: 'Balanced quality and bandwidth (32kbps, stereo)' },
  { value: 'high', label: 'High', description: 'Best quality for good connections (64kbps, stereo)' },
