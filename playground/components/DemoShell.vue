  ...
  <div class="demo-shell">
    <section v-if="overview || (prerequisites?.length ?? 0) > 0" class="demo-shell__overview">
      ...
      <ul v-if="prerequisites?.length" class="demo-shell__prereqs" aria-label="Prerequisites">
        <li
          ...
          :title="p.hint"
        >
          <span class="demo-shell__prereq-dot" aria-hidden="true"></span>
          <span>{{ p.label }}</span>
        </li>
      </ul>
    </section>
    ...
    >
      <header class="demo-shell__variant-head">
        ...
        <code v-if="v.sourceName || v.source" class="demo-shell__variant-file">{{
          v.sourceName || v.id + '.vue'
        }}</code>
      </header>
      ...
      <div class="demo-shell__stage-head" aria-hidden="true">
        <span class="demo-shell__stage-rule"></span>
      ...
      <div class="demo-shell__stage-foot" aria-hidden="true"></div>
...
const iconFor = (k: DemoNoteKind): string => (k === 'tip' ? '💡' : k === 'warning' ? '⚠️' : 'ℹ️')
...
.demo-shell__variant:nth-of-type(1) {
  animation-delay: 0.05s;
}
.demo-shell__variant:nth-of-type(2) {
  animation-delay: 0.15s;
}
.demo-shell__variant:nth-of-type(3) {
  animation-delay: 0.25s;
}
.demo-shell__variant:nth-of-type(4) {
...
.demo-shell__callout--tip .demo-shell__callout-label {
  color: var(--demo-accent);
}
...
.demo-shell__callout--note .demo-shell__callout-label {
  color: var(--demo-muted);
}
...
.demo-shell__callout--warning .demo-shell__callout-label {
  color: #b91c1c;
}
