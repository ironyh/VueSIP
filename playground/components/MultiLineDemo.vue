...
<template>
  <div class="demo-panel">
    ...
    <div class="demo-section">
      ...
      <div class="line-panel">
        ...
        >
          ...
          <div v-else class="line-info" style="opacity: 0.5">Click to receive call</div>

          <div
            v-if="line.status !== 'idle'"
            style="margin-top: 0.75rem; display: flex; gap: 0.25rem"
          >
            <button
    ...
    <div class="demo-section">
      <h3>Actions</h3>
      <div class="btn-group">
        <button class="btn btn-primary" @click="simulateIncoming">Simulate Incoming</button>
        <button
          class="btn btn-outline"
  ...
  <div class="demo-panel">
    ...
    <div class="demo-section">
      ...
      <div class="code-preview">
        <code>
          <span class="keyword">import</span> { useMultiLine } <span class="keyword">from</span>
          <span class="string">'vuesip'</span>

          <span class="keyword">const</span> { lines, activeLine, maxLines,
          <span class="function">assignCallToLine</span>,
          <span class="function">switchToLine</span>, <span class="function">holdLine</span>,
          <span class="function">resumeLine</span>, <span class="function">parkLine</span>,
          <span class="function">retrieveParked</span>,
          <span class="function">createConference</span>
          } = <span class="function">useMultiLine</span>({ maxLines:
          ...
          <span class="keyword">const</span> slot = <span class="keyword">await</span>
          <span class="function">parkLine</span>(<span class="number">1</span>)
    ...
    <div class="demo-section">
      ...
      <div class="code-preview">
        <code>
          <span class="keyword">interface</span> Line { id:
          <span class="keyword">number</span> status: <span class="string">'idle'</span> |
          <span class="string">'ringing'</span> | <span class="string">'active'</span> |
          <span class="string">'hold'</span> callSession?: CallSession remoteNumber?:
          <span class="keyword">string</span> duration:
          <span class="keyword">number</span> isActive: <span class="keyword">boolean</span>
          }
        </code>
      </div>
    </div>
