    ...
    <div class="demo-section">
      ...
      <div class="input-group">
        <input
          ...
          style="font-family: monospace; font-size: 1.5rem; letter-spacing: 0.5rem; text-align: center;"
        />
  ...
  <div class="demo-panel">
    ...
    <div class="demo-section">
      ...
      <div v-else style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
        <div
          ...
          :key="i"
          style="background: var(--bg-input); padding: 0.5rem 1rem; border-radius: 0.5rem; text-align: center;"
        >
    ...
    <div class="demo-section">
      ...
      <table style="width: 100%; font-size: 0.8rem; border-collapse: collapse;">
        ...
        <tbody>
          <tr v-for="(freqs, digit) in { '1': [697, 1209], '5': [770, 1336], '9': [852, 1477], '#': [941, 1477] }" :key="digit" style="border-bottom: 1px solid var(--border);">
