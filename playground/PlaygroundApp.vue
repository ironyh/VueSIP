    ...
    <div class="playground-content">
      ...
      <main class="playground-main">
        ...
        <div class="tab-content">
          ...
          <details v-if="isInlineLayout" class="inline-section" data-testid="inline-snippets">
            <summary>
          ...
          <details v-if="isInlineLayout" class="inline-section" data-testid="inline-setup">
...
.example-list li.active .example-info h3 {
