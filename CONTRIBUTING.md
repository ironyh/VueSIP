...
- [Quick links (maintainers & CI parity)](#quick-links-maintainers--ci-parity)

## Quick links (maintainers & CI parity)
...
- **pnpm**: Version 9.0.0 or higher (required package manager; see root `packageManager` in `package.json`)
