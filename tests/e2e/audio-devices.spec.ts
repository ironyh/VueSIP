...
test.describe('Audio Device Management', () => {
  ...
  test('should show audio quality level indicator', async ({ page }) => {
    ...
    const indicatorClass = await page
      .locator('[data-testid="quality-indicator"]')
      .getAttribute('class')
  ...
  test('should detect device changes', async ({ page }) => {
  ...
  test('should persist audio settings across navigation', async ({ page }) => {
    ...
    const noiseSuppression = await page
  ...
  test('should display device labels correctly', async ({ page, context }) => {
    ...
    const label = await page
      .locator('[data-testid="microphone-item"]:first-child [data-testid="device-label"]')
      .textContent()
  ...
  test('should show loading state during device enumeration', async ({ page }) => {
    ...
    const loadingVisible = await page
      .locator('[data-testid="devices-loading"]')
      .isVisible()
      .catch(() => false)
...
test.describe('Audio Constraints Configuration', () => {
  ...
  test('should apply custom sample rate', async ({ page }) => {
    ...
    const currentSampleRate = await page
      .locator('[data-testid="current-sample-rate"]')
      .textContent()
