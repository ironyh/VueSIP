...
test.describe('Settings Persistence', () => {
  ...
  describe('localStorage Quota Handling', () => {
    test('should handle quota exceeded error', async ({ page }) => {
      ...
      const hasError = await page.locator('[data-testid="quota-error-message"]').isVisible()
        .catch(() => false);
      const hasSuccess = await page.locator('[data-testid="save-success-message"]').isVisible()
        .catch(() => false);
  ...
  describe('Data Integrity Validation', () => {
    ...
    test('should validate checksum on load', async ({ page }) => {
      ...
      const _hasWarning = await page.locator('[data-testid="integrity-warning"]').isVisible()
        .catch(() => false);
