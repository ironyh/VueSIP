...
describe('AudioManager', () => {
  ...
  describe('Input Device Management', () => {
    ...
    it('should throw error when setting non-existent input device', async () => {
      ...
      await expect(audioManager.setInputDevice('non-existent')).rejects.toThrow('Device not found')
    })
  ...
  describe('Output Device Management', () => {
    ...
    it('should throw error when setting non-existent output device', async () => {
      ...
      await expect(audioManager.setOutputDevice('non-existent')).rejects.toThrow('Device not found')
    })
  ...
  describe('Audio Constraints', () => {
    ...
    it('should throw error when applying constraints without stream', async () => {
      ...
      await expect(audioManager.applyConstraints(constraints)).rejects.toThrow(
    ...
    it('should validate constraints before applying', async () => {
      ...
      await expect(audioManager.applyConstraints(invalidConstraints)).rejects.toThrow()
    })
  })
  ...
  describe('Stream Management', () => {
    ...
    it('should throw error when cloning without stream', () => {
      expect(() => audioManager.cloneStream()).toThrow('No active audio stream to clone')
    })
  ...
  describe('Error Handling', () => {
    it('should handle permission denied errors', async () => {
      ...
      await expect(audioManager.setInputDevice('mic-1')).rejects.toThrow('Permission denied')
    })
    ...
    it('should handle device not found errors', async () => {
      ...
      await expect(audioManager.setInputDevice('mic-1')).rejects.toThrow('Device not found')
    })
    ...
    it('should handle constraint errors', async () => {
      ...
      await expect(audioManager.applyConstraints({ sampleRate: 999999 })).rejects.toThrow()
    })
  })
