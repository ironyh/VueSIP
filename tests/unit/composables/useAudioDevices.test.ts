...
import type { AudioDevice as _AudioDevice } from '@/types/audio.types'
...
describe('useAudioDevices', () => {
  ...
  describe('Device Selection', () => {
    it('should select microphone by device ID', async () => {
      const {
        selectMicrophone,
        currentMicrophone: _currentMicrophone,
        refreshDevices,
      } = useAudioDevices()
  ...
  describe('Device Change Detection', () => {
    ...
    it('should unsubscribe from device change events', async () => {
